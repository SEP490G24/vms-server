...
public class MultiLineResponse {
    ...
    public static List<MultiLineResponse> formatDataWithMonthInYear(List<MultiLineResponse> dailyCounts) {
        ...
        List<String> allPurposes = Arrays.asList("CONFERENCES", "INTERVIEW", "MEETING", "OTHERS", "WORKING");
    ...
    public static List<MultiLineResponse> formatDataWithWeekInMonth(List<MultiLineResponse> dailyCounts, int year, int month) {
